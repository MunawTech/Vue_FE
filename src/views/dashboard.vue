  ...
  <div class="min-h-[100vh] bg-gradient-to-br from-blue-100 to-cyan-200 pb-20">
    ...
    <nav class="bg-cyan-700 text-white py-4 shadow-md">
      <div class="container mx-auto px-6 flex justify-between items-center">
        ...
        <button @click="logout" class="bg-white text-cyan-700 px-3 py-1 rounded hover:bg-cyan-100 text-sm">
          Logout
        </button>
      </div>
    </nav>
      ...
      <div v-else>
        ...
        >
          ...
          <div class="flex items-center gap-3">
            <input type="checkbox" :checked="task.completed == 1" @change="toggleComplete(task)" class="h-5 w-5 text-cyan-600" />
